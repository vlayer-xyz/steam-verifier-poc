...
export function SteamLoginButton({ webhookUrl, callbackUrl, disabled }: SteamLoginButtonProps) {
  ...
  return (
    ...
    >
      ...
      <span className="text-lg font-bold tracking-wide">Sign in with Steam</span>
      <svg
        className="w-4 h-4 text-white/90 group-hover:text-white transition-transform group-hover:translate-x-1"
        fill="none"
        stroke="currentColor"
        viewBox="0 0 24 24"
      >
